...
public class SaidaController {
    ...
    void pagar(ActionEvent event) throws IOException, InterruptedException {
        if(labelValor.getText().length() > 0 && !labelValor.getText().equals("Carro fora do estacionamento")) {
                ...
                if(car instanceof Horista) {
                    if(aux.getPlaca().equals(car.getPlaca()) && aux.getUsuario().equals(car.getUsuario()) && senha.length() < 1) {
                        ...
                        if(car.getTempoDeChegada() == 0) {
                            double valor = 0;
                            labelValor.setText("Carro fora do estacionamento");
                            labelValor.setTextFill(Paint.valueOf("#dd0303"));
                            labelPlaca.setText("");
                            labelUsuario.setText(" ");
                            labelSenha.setText(" ");
                        }
                        else {
                            double valor = (((car.getTempoDeSaida() - car.getTempoDeChegada())/10000)*AlterarValor.getValorHora());
